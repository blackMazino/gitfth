...
public class comparatorNComparable {
/*
...
class Densityy implements Comparable<Densityy>{
    int i;
    int d;
    public Densityy(int i,int d){
        this.i = i;
        this.d = d;
    }
    @Override
    public int compareTo(Densityy o) {
        // TODO Auto-generated method stub
        return d-o.d;
    }   
}
...
class Densityy2 implements Comparator<Densityy2>{
    int i;
    int d;
    public Densityy2(int i,int d){
        this.i = i;
        this.d = d;
    }
    @Override
    public int compare(Densityy2 o1, Densityy2 o2) {      
        return o2.d - o1.d;
    }   
}
