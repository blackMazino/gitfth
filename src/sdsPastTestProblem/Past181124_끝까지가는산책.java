...
public class Past181124_끝까지가는산책 {

/*
끝까지가는 산책이란 시작점(1)에서 시작하여 지나온 길외 새로운 길이 없는 노드까지 가는 걸 말한다
끝까지 가는 산책 루트중 그 코스트가 가장 작은 코스의 경로의 갯수(코스트가 같을때 지나온 경로가 다르면 다른 경로다)를 구하라
2
5 5
1 2 3
1 3 2
